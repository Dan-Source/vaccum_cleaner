...
# A* - A Star Search
mygui.title("BFS & DFS Algoritmo de IA Mundo Aspirador de Pó")

# Cria a janela com esta dimensão
mygui.geometry("650x480+100+100")
ll = Label(mygui,text="Por favor, escolha um dos algoritmos de busca:")
...
tile_clean = PhotoImage(file="Src/tile2.png")
tile_dirty = PhotoImage(file="Src/tile1.png")
...
print('-------------------------------------')
print('Localização do Cursor Atual :' , vac_pos)
print('-------------------------------------')
print('Ambiente antes de ser limpo:')
...
def rbfs(vacpos,fro_d):
    ...
    if (cleaned_pieces==dirty_pieces):
        print('-------------------------------------')
        print('Total de pisos no ambiente :' , rows*cols)
        print('Total de pisos visitados : ', visited_pieces)
        print('Total de pisos sujos : ', dirty_pieces)
        print('Total de pisos limpos : ', cleaned_pieces)
        print('Custo da memoria BFS : ', mem_cost)
        #print('The Agent\'s Score : ', cleaned_pieces/visited_pieces)
        print('-------------------------------------')
        #showing the whole env. after cleaning
        print('Ambiente depois de limpo:')
        for i in range (rows):
            print (maps[i])
        return
...
def rdfs(vacpos,fro_d):
    ...
    if (cleaned_pieces==dirty_pieces):
        print('-------------------------------------')
        print('Total de pisos no ambiente  :' , rows*cols)
        print('Pisos visitados : ', visited_pieces)
        print('Pisos sujos : ', dirty_pieces)
        print('Pìsos limpos : ', cleaned_pieces)
        print('Custo da memoria com DFS : ', mem_cost)
        #print('The Agent\'s Score : ', cleaned_pieces/visited_pieces)
        print('-------------------------------------')
        #showing the whole env. after cleaning
